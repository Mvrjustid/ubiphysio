...
def split_dataset(input_dir):
    ...
    train_subject_ids, test_val_subject_ids = train_test_split(subject_ids, test_size=0.3, stratify=[id[0] for id in subject_ids], random_state=24)
    val_subject_ids, test_subject_ids = train_test_split(test_val_subject_ids, test_size=0.5, stratify=[id[0] for id in test_val_subject_ids], random_state=24) 
...
split_dataset('./dataset/EmoPain/new_joint_vecs/')