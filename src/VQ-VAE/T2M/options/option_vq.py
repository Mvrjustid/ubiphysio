...
def get_args_parser():
    ...
    parser.add_argument('--loss-bio', type=float, default=0.1, help='hyper-parameter for the biomechanical loss')
    ...
    parser.add_argument('--gpu', default='0', type=str, help='the ID of gpu device to use.')
